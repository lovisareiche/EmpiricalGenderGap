...
%
%   Copyright 2013-2017 Inmaculada C. �?lvarez, Javier Barbero, José L. Zofío
...
%
    ...
    % Number of variables and hasConstant
    k = size(X,2);
    if ~strcmp(method,'fe')
        k = k + 1;  % For the constant term in non fe estimations
        hasConstant = 1;
    else
        hasConstant = 0;
    end
