...
vars = {'q_unemployment','q_rent','q_lending','q_interest',...
    'q_inflation','q_property','q_growth','q_fuel','q_dax','q_tax',...
    'f_nointerest','f_easy','f_short',...
    'eduschool','eduwork','hhchildren','hhinc','pinc',...
    'shop_groceries','shop_major','prep_meals',...
    'decide_finance',...
    'age','citysize','prob_intqr','prob_md','incexp_intqr',...
    'incexp_md','fin_lit_subj','fin_lit_test',...
    'female','eastgerman','non_single','east1989','full_time','part_time',...
    'unemployed','retired','leave','homemaker','civil_servant',...
    'entrepreneur','refresher','nround'};

% select vars that won't make it final
if strcmp(t,'old')
    rm = {'fin_lit_subj','fin_lit_test',...
        'incexp_intqr','incexp_md',...
        'q_growth','q_fuel','q_dax','q_tax',...
        'si_major','si_essential','si_clothing',...
...
elseif strcmp(t,'female_only')
    rm = {'q_unemployment','q_rent','q_lending','q_interest',...
    'q_property','q_growth','q_fuel','q_dax','q_tax',...
    'inflexppoint_long','homeown','exphp_point','expint_sav','f_nointerest','f_easy','f_short',...
    'eduwork','hhchildren',...
    'shop_groceries','shop_major','prep_meals',...
    'decide_finance',...
    'citysize','prob_intqr','prob_md','incexp_intqr',...
    'incexp_md','fin_lit_subj','fin_lit_test',...
    'east1989','full_time','part_time',...
    'unemployed','retired','leave','homemaker','civil_servant',...
    'entrepreneur','refresher','nround'};
else
    rm = {'fin_lit_subj','fin_lit_test','incexp_intqr','incexp_md',...
        'f_short','prob_md',...
        'leave','homemaker','civil_servant','entrepreneur'};
...
writetable([T table(y,'VariableNames',{'y'}) table(wave,'VariableNames',{'wave'}) table(id,'VariableNames',{'id'})],fullfile('empirical','0_data','manual','BOP-HH',t, 'T.csv'))
writetable([T_fin table(y_fin,'VariableNames',{'y'}) table(wave_fin,'VariableNames',{'wave'}) table(id_fin,'VariableNames',{'id'})],fullfile('empirical','0_data','manual','BOP-HH',t, 'T_fin.csv'))
